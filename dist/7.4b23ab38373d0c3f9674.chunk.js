...
Component.options.__file = "/Users/panwu/Desktop/panwu/elevator/src/views/info.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c4d035d", Component.options)
  } else {
    hotAPI.reload("data-v-5c4d035d", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('HeaderMenu', [_c('div', {
    ...
    staticClass: "info-lable"
  }, [_vm._v("用户名：")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.username))]), _vm._v(" "), _c('p'), _vm._v(" "), _c('p'), _c('div', {
    staticClass: "info-lable"
  }, [_vm._v("角色：")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.role))]), _vm._v(" "), _c('p')])])], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-5c4d035d", module.exports)
  }
}
